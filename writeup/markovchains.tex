...
The following lemmas use Jordan Canonical form to prove Theorem 5.20.
...
\begin{enumerate}
	...
	\item
			By the previous lemma and Theorem 5.19, we know the multiplicity of $1$ as eigenvalue of $A$ is 1.


	\item 
			By Theorem 5.19 \cite{friedberg2003linear}, we know all eigenvalues $\lambda$ of $A$ are contained in $S = \{ \lambda \in C: |\lambda| < 1$ or $|\lambda| = 1\}$.
			...
			Thus, by Theorem 5.13 of \cite{friedberg2003linear}, we know that $\lim_{m \to \infty} A^m$ exists.
