...
If $|\sum_{i = 1}^n x_i| = \sum_{i = 1}^{n}| x_i|$ then $\forall\ 1 \leq i \leq n\ \exists\ c_i \geq 0$ such that $x_i = c_ix_1$ (where $c_1 = 1$).
...
Inductive step:
Assume that if $|\sum_{i = 1}^{n-1} x_i| = \sum_{i = 1}^{n-1}| x_i|$ then $\forall\ 1 \leq i \leq n-1\ \exists\ c_i \geq 0$ such that $x_i = c_ix_1$ (where $c_1 = 1$)
...
and thus by assumption $\forall\ 1 \leq i \leq n-1\ \exists\ c_i \geq 0$ such that $x_i = c_ix_1$ (where $c_1 = 1$).
...
implies that $\exists c_n \geq 0$ such that $x_n = c_n(\sum_{i = 1}^{n-1} c_i)x_1$

and therefore $\exists c_n\textprime \geq 0, c_n\textprime = \sum_{i = 1}^{n-1} c_i$ such that $x_n = c_n\textprime x_1$ and thus we have shown $\forall\ 1 \leq i \leq n\ \exists\ c_i \geq 0$ such that $x_i = c_ix_1$ (where $c_1 = 1$).
