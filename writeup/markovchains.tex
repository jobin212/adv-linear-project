...
\begin{enumerate}
	...
	\item 
		...
		But we know for $n \geq 2$ that $(J_{\lambda = 1}^{\ell})_{12} = \ell \lambda^{\ell -1} = \ell * 1 = \ell$
...
\begin{enumerate}
	...
	\end{comment}
		...
		Thus $\forall i$ such that $|\lambda_i| < 1$  we have that $lim_{m \to \infty}(J_{n_i}(\lambda_i))^m$ converges to 0.
